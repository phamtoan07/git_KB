...
-- Generated 13/12/2018 6:39:57 PM from FOTEST@FO

CREATE OR REPLACE 
PACKAGE cspks_fo_common AS
   ...
   /* PROCEDURE sp_get_pp_security_amt (p_err_code in OUT VARCHAR,
    ...
    FUNCTION fn_get_root_orderid RETURN  varchar;

    FUNCTION fn_get_dealid RETURN  varchar;

    PROCEDURE sp_proces_close_market (p_err_code in OUT VARCHAR,p_date_time IN VARCHAR,
                                      p_err_msg OUT VARCHAR2 );
    /*
    ...
    FUNCTION fn_format_sequenceid(p_str IN varchar) RETURN  varchar;

    FUNCTION fn_get_buy_amt(p_account IN varchar)  RETURN NUMBER;

    --FUNCTION fn_get_asset(p_account IN varchar)  RETURN NUMBER;

    --FUNCTION fn_get_asset_amt(p_account IN varchar) RETURN NUMBER;
    ...
    --FUNCTION fn_get_order_ppse_amt(p_account IN varchar,f_fomulacd IN VARCHAR) RETURN  NUMBER;

   /* FUNCTION fn_get_ratebrk(f_cficode IN VARCHAR,
            f_ratebrk_s IN NUMBER,
            f_ratebrk_b IN NUMBER) RETURN  NUMBER; */

    PROCEDURE sp_check_reciprocal(p_err_code OUT NUMBER,
            p_custodycd IN VARCHAR, --check lenh doi ung
            p_symbol IN VARCHAR,
            p_err_msg OUT VARCHAR2,
            p_side IN VARCHAR2,
    ...
    FUNCTION fn_get_ta(p_account IN varchar, p_roomid IN varchar, p_rate_ub IN NUMBER) RETURN NUMBER;
    FUNCTION fn_get_ta_edit_order(p_account IN varchar,
                    p_roomid IN varchar,
                    p_rate_ub IN NUMBER,
                    p_delta_qtty IN NUMBER,
                    p_symbol IN VARCHAR2) RETURN NUMBER;

    FUNCTION fn_get_system_ta(p_account IN varchar) RETURN NUMBER;
    FUNCTION fn_get_system_ta_edit_order(p_account IN VARCHAR, p_delta_qtty IN NUMBER, p_symbol IN VARCHAR2) RETURN NUMBER;
    FUNCTION fn_get_ta_real_ub(p_account IN varchar,p_room_flag IN varchar, p_rate_asset_flag IN varchar,
                    p_roomid IN varchar)
            RETURN NUMBER;
    ...
    FUNCTION fn_get_estimated_debt(p_account IN varchar) RETURN  NUMBER ;
